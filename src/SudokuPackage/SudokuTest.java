...
public class SudokuTest {
    ...
    public void SudokuTrue() {
        ...
        SudokuGenerator.writeMatrix(test1);
        SudokuGenerator.writeMatrix(test2);
    ...
    public void SudokuFalse(){
        ...
        int[][] test6 = {{4,2,9,8,1,3,5,6,7}, {5,1,6,4,7,2,9,3,8}, {7,8,3,6,5,9,2,4,1},
                ...
                {1,5,8,3,6,7,4,9,2}, {9,3,4,5,2,8,7,1,6}, {2,6,5,9,4,1,3,8,7}};
        SudokuGenerator.writeMatrix(test3);
        SudokuGenerator.writeMatrix(test4);
        SudokuGenerator.writeMatrix(test5);
        SudokuGenerator.writeMatrix(test6);
